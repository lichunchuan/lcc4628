...
//import com.example.shiro.AliyunConfig;
...
//    // 允许上传的格式
//    private static final String[] IMAGE_VEDIO_TYPE = new String[]{".bmp", ".jpg",
//            ".jpeg", ".gif", ".png",".AVI","mp4","rmvb"};
//    @Autowired
...
//        for (String type : IMAGE_VEDIO_TYPE) {
